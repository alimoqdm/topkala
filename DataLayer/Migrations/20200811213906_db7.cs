        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ForeignNational = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttibuteGroups", x => x.AttributeGroupId);
                    table.ForeignKey(
                        name: "FK_AttibuteGroups_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SilderId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CategoryId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SilderImage", x => x.SilderId);
                    table.ForeignKey(
                        name: "FK_SilderImage_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "CategoryId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attributes_AttibuteGroups_AttributeGroupId",
                        column: x => x.AttributeGroupId,
                        principalTable: "AttibuteGroups",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceWithReduction = table.Column<int>(nullable: false),
                    Reduction = table.Column<int>(nullable: false),
                    ...
                    UserLike = table.Column<string>(nullable: true),
                    CategoryId = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttributeId = table.Column<int>(nullable: false),
                    ProductId = table.Column<int>(nullable: false),
                    Value = table.Column<string>(maxLength: 600, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductColorId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(nullable: false),
                    ColorName = table.Column<string>(maxLength: 150, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductPathImages", x => x.MyProperty);
                    table.ForeignKey(
                        name: "FK_ProductPathImages_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    QuestionId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(nullable: false),
                    ask = table.Column<string>(maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttibuteGroups_CategoryId",
                table: "AttibuteGroups",
                column: "CategoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductPathImages_ProductId",
                table: "ProductPathImages",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SilderImage_CategoryId",
                table: "SilderImage",
                column: "CategoryId");
        }
